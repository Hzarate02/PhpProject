...
class ControladorProductos
{
	...
	public static function ctrCrearProducto()
	{
		...
		if (isset($_POST["nuevaDescripcion"])) {
			if (
				preg_match('/^[a-zA-Z0-9ñÑáéíóúAÉÍÓÚ ]+$/', $_POST["nuevaDescripcion"])
				...
				if ($respuesta == "ok") {
                    ...
                    Swal.fire({
                        icon: "success",
                        title: "El Producto ha sido guardada correctmente",
				...
				Swal.fire({
					icon: "error",
					title: "¡El producto no puede ir con los campos vacíos llevar caracteres especiales!",
					showConfirmButtonText: true,
					confirmButtonTect: "Cerrar"
					}).then()¿(result) => {
						if(result.value){
							window.lovation = "productos";
						}
					})
				</script>';
			}
